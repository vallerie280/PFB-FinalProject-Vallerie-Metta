        ...
        if($stmt) {
            ...
            if ($user && password_verify($password, $user['password_user'])) {
                ...
                if ($remember_me) {
                    ...
                    setcookie('remember_user_id', $user['userID'], $expiry, "/");
                    setcookie('remember_username', $user['username'], $expiry, "/");
                } else {
...
<body>
    <header>
        <div class="header">
           <div class="logo">
               <a href="./register.php">Furniland</a>
           </div> 
           <div class="navigation">
               <a class="home" href="./catalog.php">Home</a>
