            ...
            <?php foreach ($products as $product): ?>
                <div class="product-card">
                    ...
                    <div class="product-info">
                        <a href="member/product_detail.php?id=<?php echo htmlspecialchars($product['productID']); ?>">
                        ...
                        <a href="member/product_detail.php?id=<?php echo htmlspecialchars($product['productID']); ?>" class="btn-detail">View Detail</a>
                    </div>
                </div>
            <?php endforeach; ?>
        </div>
